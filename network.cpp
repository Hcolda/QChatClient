...
Network::Network(QObject *parent)
    : QObject{parent}, m_has_connected{false}, m_can_read{false} {
...
#endif
  connect(&m_ssl_socket, &QAbstractSocket::errorOccurred, this,
          &Network::errorOccurred);
  connect(&m_ssl_socket, &QSslSocket::readyRead, this, &Network::readyReadSlot);
  connect(&m_ssl_socket, &QSslSocket::disconnected, this,
          &Network::disconnectedSlot);
}
