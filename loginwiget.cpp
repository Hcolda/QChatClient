    ...
    , ui(new Ui::LoginWiget)
{
    ...
    connect(ui->loginPushButton, &QPushButton::clicked, this, &LoginWiget::loginSlot);
    connect(ui->registerPushButton,  &QPushButton::clicked, this, &LoginWiget::registerSlot);
}
